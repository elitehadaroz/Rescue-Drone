...
class Report:
    def __init__(self):
        ...
        #self.create_folder()
        #self.__data_report = {'date':,'home location':,'drone connect time':,'start mission':,'end mission':,'air time':,'number waypoint':,}
        self.__data_report = {}
        self.__date = []
    ...
    def set_max_alt(self,alt):
        ...
        self.__data_report.get('max altitude')
    ...
    def set_person_loc(self,loc,name):
        ...
        self.__data_report['persons location'] = this + [person]
